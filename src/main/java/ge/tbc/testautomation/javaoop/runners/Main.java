...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Length of the circle: " + circle.getLength());
        circle.printPackageName();

        IResizableCircle resizableCircle = circle;
        Circle doubleSizedCircle = resizableCircle.returnDoubleSizedCircle(circle);
        Circle customSizedCircle = resizableCircle.returnCustomSizedCircle(circle, 9.8);
        ...
        IValidCircle validCircle = circle;
        boolean isCircleValid = validCircle.validateCircle(circle);
        System.out.println("Is the circle valid? " + isCircleValid);
//        try {
//            Circle circle = new Circle(-5.0);
